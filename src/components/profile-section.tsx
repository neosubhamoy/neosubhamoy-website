...
export default function ProfileSection({ props }: { props: ProfileSectionProps }) {
    return (
        <section className="flex flex-col">
            ...
            <div className="p-4 border-b-2 border-t bg-[repeating-linear-gradient(315deg,var(--border-lite)_0,var(--border-lite)_1px,transparent_0,transparent_50%)] bg-size-[10px_10px]"></div>
            <h2 className="sr-only">Overview</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 p-3 gap-x-6 gap-y-2.5 border-b relative">
