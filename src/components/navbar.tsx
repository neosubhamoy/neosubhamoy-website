            ...
            <div className="flex items-center justify-between w-[50%] p-1 border-x">
                ...
                <div className="flex items-center px-1 gap-2">
                    <div className="flex items-center gap-4 mr-2">
                        <a href="#projects" className="text-sm font-medium text-muted-foreground hover:text-primary">Projects</a>
                        <a href="/showcase" className="text-sm font-medium text-muted-foreground hover:text-primary">Showcase</a>
                        <a href="/blog" className="text-sm font-medium text-muted-foreground hover:text-primary">Blog</a>
                        <a href="/sponsors" className="text-sm font-medium text-muted-foreground hover:text-primary">Sponsors</a>
                    </div>
                    <Separator orientation="vertical" className="h-5 my-2" />
                    <Button variant="ghost" className="group px-1.5 rounded-md">
                        <Search className="w-4 text-muted-foreground group-hover:text-primary" />
                        <KbdGroup>
